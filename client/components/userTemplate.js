...
export default React.createClass({
  render () {
    ...
    return (
      <div>
        <input ref="name" placeholder="Name" className="input-large col-xs-12 col-md-12 col-lg-12" value={editUser.name} required />
        <input ref="email" type="email" placeholder="Email" className="input-large col-xs-12 col-md-12 col-lg-12" value={editUser.email} required />
